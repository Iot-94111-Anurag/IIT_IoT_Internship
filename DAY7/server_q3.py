...
def create_data():
    ...
    query=f"insert into sensor_readings values('{device}','{light}','{fan}',{temp});"
...
def update_data():
    ...
    query=f"update sensor_readings SET light_status='{light}',fan_status='{fan}' where device_name='{device}';"
...
def delete_data():
    ...
    query=f"delete from sensor_readings where device_name='{device}';"
    executeQuery(query=query)
